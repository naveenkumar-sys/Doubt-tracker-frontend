...
import { CheckCircle, Clock, HelpCircle, Loader2, MessageSquare, ThumbsUp, User, X } from 'lucide-react';
...
const DoubtDetailModal = ({ doubtId, onClose, onUpdate }) => {
    ...
    const isOwner = user?._id === doubt.studentId?._id || user?._id === doubt.studentId;
                            ...
                            <div className="space-y-4">
                                {answers.map((answer) => (
                                    ...
                                    >
                                        ...
                                        {isOwner && !answer.isAccepted && doubt.status !== 'closed' && (
